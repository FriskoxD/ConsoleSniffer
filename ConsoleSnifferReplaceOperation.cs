 ...
 * File: ConsoleSnifferRecplaceOperation.cs
 *
...
{
    class ConsoleSnifferReplaceOperation : ConsoleSnifferAction
    {
        string orig = "";
        string repl = "";

        public ConsoleSnifferReplaceOperation(string original, string replacement)
        {
            orig = original;
            repl = replacement;
        }
