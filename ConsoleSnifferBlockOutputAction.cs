 ...
 * File: ConsoleSnifferBlockOutputAction.cs
 *
...
{
    class ConsoleSnifferBlockOutputAction : ConsoleSnifferAction
    {
        bool blocking = false;

        public ConsoleSnifferBlockOutputAction(bool value)
        {
            blocking = value;
        }
        ...
        {
            ConsoleSniffer.SingleOutputBlock(blocking);
            return true;
        }
    }
}
